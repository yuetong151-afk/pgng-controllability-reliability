// M1_sh: Baseline split-half / test-retest version
// Parameters: b1, b2, b3, b4, a1, a2 (6 params)
...
parameters {
    ...
    matrix[6,2]   theta_mu;                 // Population-level effects (6 params x 2 halves)
    matrix[6,NJ]  theta_c_pr;              // Standardized subject-level effects (common)
    matrix[6,NJ]  theta_d_pr;              // Standardized subject-level effects (divergent)
